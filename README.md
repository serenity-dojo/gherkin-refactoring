...
```java
class SearchForm {
    static By SEARCH_FIELD = By.cssSelector(pattern-1-deUIication);
    static By SEARCH_BUTTON = By.cssSelector(pattern-1-deUIication);
}
```
...
public class SearchFor {
    ...
    public static Performable term(String term) {
        return Task.where(pattern-1-deUIication,
